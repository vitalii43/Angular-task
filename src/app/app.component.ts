...
import { retry, delay, concatMap, concat, reduce, tap, map, publish,
  elementAt, filter, last, catchError, takeLast, finalize, mergeMap,
  skipWhile, groupBy, throttle, merge  } from 'rxjs/operators';
...
export class AppComponent implements OnInit, OnDestroy {
  ...
  ngOnInit() {
    ...
    toLogarifm.subscribe(val => console.log(`logarithm : ${val}`));
